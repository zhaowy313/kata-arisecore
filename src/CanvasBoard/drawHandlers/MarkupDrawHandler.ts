...
export default abstract class MarkupDrawHandler<P = {}> extends DrawHandler<
  MarkupDrawHandlerParams & P
> {
  grid(
    canvasCtx: CanvasRenderingContext2D,
    boardConfig: CanvasBoardConfig,
    boardObject: MarkupBoardObject,
  ) {
  ...
  getColor(boardConfig: CanvasBoardConfig, boardObject: MarkupBoardObject) {
